...
{
    public class MainAttributeRepository:BaseRepository<MainAttributes>,IMainAttributesRepository
    {
        public MainAttributeRepository(ApplicationDbContext context) : base(context)
        {
