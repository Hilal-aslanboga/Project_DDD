...
using Project_DDD.InfrastructureLayer.Mapping.Concrete;
using System;
using System.Collections.Generic;
using System.Text;

namespace Project_DDD.InfrastructureLayer.Context
{
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUsers>()
                ...
                new AppUsers
                {
                    ...
                    Status = Status.Active,
                    FullName = "Hilal Aslanboga",
                    ImagePath = "/images/users/default.jpg",
                    TwoFactorEnabled = false,
                    LockoutEnabled = false,
                    SecurityStamp = "hotmail",
            ...
            builder.Entity<MainCategories>().HasData(new MainCategories
            {
                ...
                CreateDate = DateTime.Now,
                Description = "Aydınlatma ve Ekipmanları",
                Id = 1,
