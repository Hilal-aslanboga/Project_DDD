...
namespace Project_DDD.PresentationLayer.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductService productService, IBrandService brandService, IMainCategoryService maincategoryService, ISubCategoryService subcategoryService, IProductPictureService productPictureService, IBasketService basketService, IAppUserService userService)
        {
